...
QUnit.module('Services', {
    ...
    QUnit.test('Display a simple notification', function (assert) {
        ...
        assert.strictEqual(_.str.trim($notification.html().replace(/\s+/g, ' ')),
            "<div class=\"o_notification_title\"> <span class=\"o_icon fa fa-3x fa-lightbulb-o\" role=\"img\" aria-label=\"Notification undefined\" title=\"Notification undefined\"></span> a </div> <div class=\"o_notification_content\">b</div>",
    ...
    QUnit.test('Display a warning', function (assert) {
        ...
        var $notification = $('body .o_notification_manager .o_notification');
        assert.strictEqual(_.str.trim($notification.html().replace(/\s+/g, ' ')),
            "<div class=\"o_notification_title\"> <span class=\"o_icon fa fa-3x fa-exclamation\" role=\"img\" aria-label=\"Notification undefined\" title=\"Notification undefined\"></span> a </div> <div class=\"o_notification_content\">b</div>",
            "should display notification");
        view.destroy();
        setTimeout(done);
    });
