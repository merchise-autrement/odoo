odoo.define("web_celery.widgets", function (require) {
     ...
     */
    const AbstractProgressBar = Widget.extend({
        /**
     ...
     *
     */
    const BasicProgressBar = AbstractProgressBar.extend({
     ...
     */
    const FullScreenProgressBar = BasicProgressBar.extend({
        xmlDependencies: ["/web_celery/static/src/xml/templates.xml"],
    ...
    const FullScreenCeleryProgressBar = FullScreenProgressBar.extend(
